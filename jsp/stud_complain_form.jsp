    ...
    %>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="container " id="black" style="display:none;">
                                            <h5><span class="fa fa-check"></span>Complain issued Successfully.</h5>
                                        </div>
                                        <div class="container" id="failure" style="display:none;">
                                         <h5 style="color:red;"><span class="fa fa-exclamation"></span> Complain did not issue failed!</h5>
                                     </div>
  	  ...
  	  $('#reg-form').on('submit',function(event){
  		  ...
  		  $.ajax({
  			  ...
  			  url:"insert_complain_db.jsp",
  			  type:'POST',
  			  data: form,
  			  success: function (data,textStatus,jqXHR){
  				 if(data.trim()==='Complain issued!!'){
  					 $('#loader').hide();
  					 $("#failure").hide();
  					 $("#black").show();
  					  console.log(data);
