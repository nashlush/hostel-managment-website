...
<html>
<head>
<title>Displaying student complains</title>
...
try {
   ...
   String permissionhostelid = (String)session.getAttribute("wardenhostelid");
        ...
        PreparedStatement pst = conn.prepareStatement("Select complain_id,room_no,complain,complain_date from student_complain_details where hostelid=?");
...
<table  class="table table-bordered">
	...
	Data from the table 'Complain' of database 'test' </font>
	</caption>-->
