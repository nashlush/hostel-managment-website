...
String visitname = (String) session.getAttribute("visitname");
String selfcontact = (String) session.getAttribute("selfcontact");
String parentcontact = (String) session.getAttribute("parentcontact");
String leavereason = (String) session.getAttribute("leavereason");
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <pre>
                                    <form action="permission.jsp" method="POST">
                                    <i>
 Respected Sir/Madam,

       I am ${fullname} currently studying in ${currentyear} ${branchname} department.
       I reside in the college Hostel in room number ${roomno}.

       I would sincerely request for a leave period between ${fromdate} to ${todate}
       for reason being : ${leavereason}. I will be staying with ${visitname}. I will
       be visiting ${address} place for this time period. Here are some of the
       details and contact information in case of emergency:

       Self : ${selfcontact}
       parent contact number : ${parentcontact}

       I kindly request you to grant my leave.
       Thank you.

        Sincerely,
        ${fullname}
        ${currentyear} ${branchname} </i>
                                </pre>
                            ...
                            <div class="panel panel-default">
                                ...
                                <center>Your Complain Will Appear Here, If you have any.</Center>
                                <!--likhoooo-->
                            </div>
                        </div>
                        <!-- /.col-lg-8 -->
